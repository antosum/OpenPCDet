...
[PyTorch](https://pytorch.org/docs/stable/index.html) [Domains](https://pytorch.org/pytorch-domains)
...
- Docs
  ...
  - [Domains](https://pytorch.org/pytorch-domains)
...
[Skip to main content](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html#main-content)
...
[![](https://docs.pytorch.org/tutorials/_static/img/pytorch-colab.svg)\\
\\
Run in Google Colab\\
\\
Colab](https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/38991cbc7763ed7e0f1b711da737b391/tuning_guide.ipynb) [![](https://docs.pytorch.org/tutorials/_static/img/pytorch-download.svg)\\
\\
Download Notebook\\
\\
Notebook](https://docs.pytorch.org/tutorials/_downloads/38991cbc7763ed7e0f1b711da737b391/tuning_guide.ipynb) [![](https://docs.pytorch.org/tutorials/_static/img/pytorch-github.svg)\\
\\
View on GitHub\\
\\
GitHub](https://github.com/pytorch/tutorials/blob/main/recipes_source/recipes/tuning_guide.py)

Note

[Go to the end](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html#sphx-glr-download-recipes-recipes-tuning-guide-py)
to download the full example code.

# Performance Tuning Guide [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#performance-tuning-guide "Link to this heading")
...
## Overview [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#overview "Link to this heading")
...
## General optimizations [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#general-optimizations "Link to this heading")
...
### Enable asynchronous data loading and augmentation [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#enable-asynchronous-data-loading-and-augmentation "Link to this heading")
...
### Disable gradient calculation for validation or inference [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#disable-gradient-calculation-for-validation-or-inference "Link to this heading")
...
### Disable bias for convolutions directly followed by a batch norm [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#disable-bias-for-convolutions-directly-followed-by-a-batch-norm "Link to this heading")
...
### Use parameter.grad = None instead of model.zero\_grad() or optimizer.zero\_grad() [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#use-parameter-grad-none-instead-of-model-zero-grad-or-optimizer-zero-grad "Link to this heading")
...
### Fuse operations [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#fuse-operations "Link to this heading")
...
@torch.compile
def gelu(x):
    return x * 0.5 * (1.0 +  [torch.erf](https://docs.pytorch.org/docs/stable/generated/torch.erf.html#torch.erf "torch.erf")(x / 1.41421))
...
### Enable channels\_last memory format for computer vision models [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#enable-channels-last-memory-format-for-computer-vision-models "Link to this heading")
...
### Checkpoint intermediate buffers [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#checkpoint-intermediate-buffers "Link to this heading")
...
### Disable debugging APIs [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#disable-debugging-apis "Link to this heading")
...
## CPU specific optimizations [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#cpu-specific-optimizations "Link to this heading")

### Utilize Non-Uniform Memory Access (NUMA) Controls [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#utilize-non-uniform-memory-access-numa-controls "Link to this heading")
...
### Utilize OpenMP [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#utilize-openmp "Link to this heading")
...
### Intel OpenMP Runtime Library ( `libiomp`) [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#intel-openmp-runtime-library-libiomp "Link to this heading")
...
### Switch Memory allocator [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#switch-memory-allocator "Link to this heading")
...
### Train a model on CPU with PyTorch [\`\`](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#id3) DistributedDataParallel\`\`(DDP) functionality [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#train-a-model-on-cpu-with-pytorch-distributeddataparallel-ddp-functionality "Link to this heading")
...
## GPU specific optimizations [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#gpu-specific-optimizations "Link to this heading")

### Enable Tensor cores [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#enable-tensor-cores "Link to this heading")
...
### Use CUDA Graphs [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#use-cuda-graphs "Link to this heading")
...
# It can be enabled using
 [torch.compile](https://docs.pytorch.org/docs/stable/generated/torch.compile.html#torch.compile "torch.compile")(m, "reduce-overhead")
# or
 [torch.compile](https://docs.pytorch.org/docs/stable/generated/torch.compile.html#torch.compile "torch.compile")(m, "max-autotune")
...
### Enable cuDNN auto-tuner [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#enable-cudnn-auto-tuner "Link to this heading")
...
```
[torch.backends.cudnn.benchmark](https://docs.pytorch.org/docs/stable/backends.html#torch.backends.cudnn.benchmark "torch.backends.cudnn.benchmark")  = True
...
### Avoid unnecessary CPU-GPU synchronization [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#avoid-unnecessary-cpu-gpu-synchronization "Link to this heading")
...
### Create tensors directly on the target device [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#create-tensors-directly-on-the-target-device "Link to this heading")
...
### Use mixed precision and AMP [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#use-mixed-precision-and-amp "Link to this heading")
...
### Preallocate memory in case of variable input length [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#preallocate-memory-in-case-of-variable-input-length "Link to this heading")
...
## Distributed optimizations [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#distributed-optimizations "Link to this heading")

### Use efficient data-parallel backend [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#use-efficient-data-parallel-backend "Link to this heading")
...
### Skip unnecessary all-reduce if training with `DistributedDataParallel` and gradient accumulation [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#skip-unnecessary-all-reduce-if-training-with-distributeddataparallel-and-gradient-accumulation "Link to this heading")
...
### Match the order of layers in constructors and during the execution if using `DistributedDataParallel(find_unused_parameters=True)` [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#match-the-order-of-layers-in-constructors-and-during-the-execution-if-using-distributeddataparallel-find-unused-parameters-true "Link to this heading")
...
### Load-balance workload in a distributed setting [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#load-balance-workload-in-a-distributed-setting "Link to this heading")
...
## Conclusion [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#conclusion "Link to this heading")
...
## Further Reading [\#](https://docs.pytorch.org/tutorials/recipes/recipes/tuning_guide.html\#further-reading "Link to this heading")
...
[`Download Jupyter notebook: tuning_guide.ipynb`](https://docs.pytorch.org/tutorials/_downloads/38991cbc7763ed7e0f1b711da737b391/tuning_guide.ipynb)

[`Download Python source code: tuning_guide.py`](https://docs.pytorch.org/tutorials/_downloads/8c82db84c10318a94cbe213adb618139/tuning_guide.py)

[`Download zipped: tuning_guide.zip`](https://docs.pytorch.org/tutorials/_downloads/810e65eb9306212bd714a1fce48d023b/tuning_guide.zip)
...
![](https://docs.pytorch.org/tutorials/_static/img/pytorch-x.svg)